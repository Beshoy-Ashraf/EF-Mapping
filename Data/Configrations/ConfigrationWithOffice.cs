...
public class ConfigrationWithOffice : IEntityTypeConfiguration<Office>
{
      public void Configure(EntityTypeBuilder<Office> builder)
      {
            ...
            builder.Property(x => x.OfficeName).HasColumnType("VARCHAR").HasMaxLength(250);
            builder.Property(x => x.OfficeLocation).HasColumnType("VARCHAR").HasMaxLength(250);
      ...
      private List<Office> IntitialData()
      {

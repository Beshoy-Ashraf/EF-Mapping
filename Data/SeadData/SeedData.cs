...
namespace Mapping.Data.SeadData;
      ...
      public static List<Course> LoadCourses() => new()
        {
           ...
           new Course { Id = 5, Name = "CS-50", Price = 3000.00m }
        };

      // Method to load data for Schedules
      public static List<Schedule> LoadSchedules() => new()
        {
          new Schedule { Id = 1, Title = SchudelTitelEnum.Daily,       MeetingDay = WeekDay.Saturday & WeekDay.Friday},
          new Schedule { Id = 2, Title = SchudelTitelEnum.DayAfterDay, MeetingDay = WeekDay.Saturday & WeekDay.Friday},
          new Schedule { Id = 3, Title = SchudelTitelEnum.TwiceAWeek,  MeetingDay = WeekDay.Saturday & WeekDay.Friday },
          new Schedule { Id = 4, Title = SchudelTitelEnum.Weekend,     MeetingDay = WeekDay.Saturday & WeekDay.Friday },
          new Schedule { Id = 5, Title = SchudelTitelEnum.Weekend,     MeetingDay = WeekDay.Saturday & WeekDay.Friday}
        };
